      ...
      <main className="min-h-screen bg-gradient-to-b from-stone-50 to-white">
        ...
        <section className="py-16 md:py-24 bg-gradient-to-br from-emerald-50 via-white to-amber-50">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-6">About BidXpress</h1>
        ...
        <section className="py-16 md:py-20 bg-gradient-to-r from-emerald-50 to-amber-50 border-y border-emerald-100">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center max-w-3xl mx-auto mb-16">
                <h2 className="text-2xl md:text-3xl lg:text-4xl font-extrabold text-gray-900 leading-tight"> Our Core Values </h2>
       ...
       {/* feedback section */}
        <section className="py-16 md:py-20 mb-[-40px] bg-gradient-to-br from-emerald-50 via-white to-amber-50">
            <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-4">We're Always Listening</h2>
